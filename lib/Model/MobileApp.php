 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MobileApp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'mobileApp';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9]*$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling MobileApp., must conform to the pattern /^[0-9]*$/.");
        }
