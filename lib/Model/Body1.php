...
class Body1 implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param string $name The name of the access service as it will appear in customer's profile.
     *
     * @return $this
     */
     ...
     * Sets customer_id
     *
     * @param string $customer_id Customer id which is returned by the GET endpoint.
     *
     * @return $this
     */
