...
/**
 * UnlockPayload Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UnlockPayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'unlockPayload';
    ...
    protected static $setters = [
        'delegated_user' => 'setDelegatedUser'
    ];
    ...
    {
        $this->container['delegated_user'] = isset($data['delegated_user']) ? $data['delegated_user'] : null;
    }
    ...
    {
        return $this->container['delegated_user'];
    }

    /**
     * Sets delegated_user
     *
     * @param string $delegated_user delegated_user
     *
     * @return $this
     */
    public function setDelegatedUser($delegated_user)
    {
        $this->container['delegated_user'] = $delegated_user;
