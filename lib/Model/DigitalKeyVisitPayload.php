 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DigitalKeyVisitPayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'digitalKeyVisitPayload';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mobile_app'] === null) {
            $invalidProperties[] = "'mobile_app' can't be null";
        }
        if ($this->container['install_notification'] === null) {
            $invalidProperties[] = "'install_notification' can't be null";
        }
