...
class SpecialDayApi
{
    ...
    {
        list($response) = $this->changeSpecialDaysWithHttpInfo($site_id, $body);
        return $response;
    }

    /**
     * Operation changeSpecialDaysWithHttpInfo
     *
     * changes the configuration of special days
     *
     * @param  string $site_id ID of site to work (required)
    ...
    /**
     * Operation changeSpecialDaysAsync
     *
     * changes the configuration of special days
     *
     * @param  string $site_id ID of site to work (required)
     ...
     */
    public function changeSpecialDaysAsync($site_id, $body)
    {
        return $this->changeSpecialDaysAsyncWithHttpInfo($site_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation changeSpecialDaysAsyncWithHttpInfo
     *
     * changes the configuration of special days
     *
     * @param  string $site_id ID of site to work (required)
    ...
    /**
     * Create request for operation 'changeSpecialDays'
     *
     * @param  string $site_id ID of site to work (required)
     * @param  object $body special day changes (required)
     *
     ...
     */
    protected function changeSpecialDaysRequest($site_id, $body)
    {
        // verify the required parameter 'site_id' is set
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling changeSpecialDays'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling changeSpecialDays'
            );
        }

        $resourcePath = '/{siteId}/specialdays';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getSpecialDaysWithHttpInfo($site_id);
        return $response;
    }

    /**
     * Operation getSpecialDaysWithHttpInfo
     *
     * get all special days
     *
     * @param  string $site_id ID of site to work (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpecialDaysAsync($site_id)
    {
        return $this->getSpecialDaysAsyncWithHttpInfo($site_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSpecialDaysAsyncWithHttpInfo
     *
     * get all special days
     *
     * @param  string $site_id ID of site to work (required)
    ...
    /**
     * Create request for operation 'getSpecialDays'
     *
     * @param  string $site_id ID of site to work (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSpecialDaysRequest($site_id)
    {
        // verify the required parameter 'site_id' is set
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling getSpecialDays'
            );
        }
